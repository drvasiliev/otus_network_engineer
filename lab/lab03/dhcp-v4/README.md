...
##### Шаг 3: Проверьте конфигурацию сервера DHCPv4
    ...
    b.	Выполните команду show ip dhcp bindings изучить установил DHCP-адреса назначения.
    c.	Выполните команду sshow ip dhcp server statistics для проверки сообщений DHCP.
