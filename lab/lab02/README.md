...
###### У S2 STP выбрал порт Fa0/1 рутом потому что у него самый низкий идентификатор (он самый меньший порт). На S3 выбран порт Fa0/3 рутом, так как на S1 порт Fa0/3 меньший порт и STP заблокировал порт Fa0/4 на S3.
